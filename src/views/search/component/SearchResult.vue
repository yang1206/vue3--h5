...
const props = defineProps({
  gameList: {
    type: Array as PropType<IGameList[]>,
  },
  tagList: {
    type: Array
  }
...
<template>
  ...
  <div class="container">
    <div v-for="(item, index) in props.gameList" :key="item.id">
      <div class="content">
        <div class="left">
          <van-image alt="" lazy-load width="70" height="70" :src="item.icon" />
          <p class="grade">评分：<span>{{ item.grade }}</span></p>
        </div>
        <div class="right">
          ...
          <div class="tag">
            ...
            <span v-for=" (i) in props.tagList[index]">
