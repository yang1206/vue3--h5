...
<template>
    <van-sticky>
        <van-nav-bar :title="title" @click-left="clickLeft" @click-right="clickRight" safe-area-inset-top left-arrow>
            <template #left>
                <van-icon :color="color" size="20" :name="leftIcon" /><span :style="color">{{ leftText }}</span>
            </template>
